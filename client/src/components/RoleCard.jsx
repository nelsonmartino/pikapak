const RoleCard = ({ info }) => {
  return (
    <div className="flex flex-col my-6  p-4 items-center text-[#3e047c] rounded-xl shadow-xl group border-2 -gray-300  xl:w-72 w-[80%] ">
      <div className="flex p-4 overflow-hidden text-white w-full justify-center xl:mb-4 xl:h-[17rem] h-full">
      ...
      <div className="flex flex-col justify-between items-center flex-grow h-full">
        <div className="flex flex-col items-center flex-grow h-full ">
          ...
          <div className="flex justify-center flex-col items-center xl:flex-grow h-full ">
            <div className="flex flex-col items-center xl:p-6">
