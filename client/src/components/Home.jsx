...
const Home = () => {
    ...
    return (
        <div className='bg-[url("./assets/imgs/Background_header.png")] bg-cover bg-center bg-no-repeat overflow-x-hidden' id='home'>
            ...
            <div className='relative h-[100vh]  bg-[url("./assets/imgs/pikapak-viajas.png")] xl:bg-cover bg-center bg-no-repeat bg-fixed xl:bg-fixed xl:bg-[length:99.9%_99.9%] bg-[length:100%]' >
