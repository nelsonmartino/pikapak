...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/newsletter`,
        formData
      )
  ...
  return (
    <>
      <div
        className='bg-[url("./assets/imgs/Background_header.png")] bg-cover bg-center bg-no-repeat overflow-x-hidden'
        id="home"
      >
        <div className=" max-w-[1100px] flex justify-center xl:py-12 py-4 xl:m-auto ">
          <div className="max-w-[77%] mt-[5rem] xl:mt-[3rem] ">
            <p className="relative text-[1rem] font-extrabold pt-0 pb-[7px] leading-[15px] tracking-[1px] uppercase text-[#ffb200]">
              ENVIA CON PIKAPAK
            </p>
            <div>
              <h2 className="relative xl:text-[64px] text-[42px] pt-[8px] font-bold leading-[5rem] text-white z-20">
                Enviá (casi) cualquier cosa,
                <br /> a todos lados, <br />
                <div
                  className="inline-block  text-[#ffb200]  whitespace-nowrap min-w-[200px] overflow-hidden"
                  style={{
                    minHeight: '5rem',
