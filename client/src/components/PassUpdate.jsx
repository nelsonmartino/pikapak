    ...
    <>
      <div className="xl:w-1/2 flex flex-col xl:m-auto xl:mt-[7%] mx-4 ">
        ...
        <form
          ...
          className="w-full flex flex-col rounded-xl shadown-xl p-8 xl:px-8  border-2 border-[#3C047B] border-solid shadow-xl gap-4"
        >
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full text-center">
              <h4 className="text-xl font-semibold mb-2">
                ¡Modificaste tu contraseña!
              </h4>
              <p className="text-gray-600 mb-4">
                Volvé a loguearte con tu nueva contraseña.
              </p>
              <button
