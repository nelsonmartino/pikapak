function PartSix() {
  return (
    <div className="flex flex-col items-center justify-center pt-4 pb-4 min-h-screen text-[#3e047c]">
      ...
      <div className="font-semibold text-lg text-[#3e047c] my-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-14 w-full  px-4">
        ...
        <div className="min-h-screen flex items-center justify-center ">
          ...
          <div>
            ...
            <div className="w-72 h-36 mt-3 border border-2 border-[#3e047c] p-1 flex justify-center items-center">
              <p>
                Lo llevas al Hub Remitente (deposito) que mas te convenga (hay
                muchos en la ciudad!)
              </p>
            </div>
            <div className="w-72 h-36 mt-3 border border-2 border-[#3e047c] p-1 flex justify-center items-center">
            ...
            <div className="w-72 h-36 mt-3 border border-2 border-[#3e047c] p-1 flex justify-center items-center">
              <p>
                Cuando le paquete llega, les informamos a vos y al destinatario.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="min-h-screen flex  justify-center">
          <div>
            <div className="w-72 h-36 mt-3 border border-2 border-[#3e047c] p-1 flex justify-center items-center">
              <p>
                Si lo haces habitualmente y SI TENES un local, Registrate como
                Hub Remitente
              </p>
            </div>
            ...
            <div className="w-72 h-36 mt-3  border border-2 border-[#3e047c] p-1 flex justify-center items-center">
              <p>
                O completa este simple formulario y te contactamos a la brevedad
              </p>
            </div>
          </div>
        </div>
