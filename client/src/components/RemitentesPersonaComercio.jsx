...
function RemitentesPersonaComercio() {
    return (
        <div className="flex flex-col h-full content-center">
            ...
            <div className=" h-full flex items-center mt-[0.5rem] bg-[#e9eaea] bg-opacity-70  drop-shadow-lg bg-no-repeat shadow-lg" >
            ...
            <div className="h-full flex  bg-[#e9eaea] bg-opacity-70 drop-shadow-lg bg-no-repeat shadow-lg bg-opacity-30">
