...
export default function validateForm(formData) {
  ...
  if (!formData.whatsapp.trim()) {
    ...
    errors.whatsapp =
      'Por favor, introduce un número válido de Argentina (ej: +54 11 1234 5678, sin espacios intermedios).'
  }

  if (formData.password.length < 6 || formData.password.length > 14) {
    errors.password = 'La contraseña debe contener entre 6 y 14 caracteres.'
  }
